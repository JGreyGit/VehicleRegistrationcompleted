...
public class ExecuteScreenCapture {
    ...
    public static  void TakeScreenShot(String screenshotName) throws IOException {
      ...
      FileHandler.copy(screenshot,new File("C:\\Users\\JoeObasogie\\IdeaProjects\\VehicleRegistration\\src\\test\\java\\CapturedScreenShots\\FailedAutomation" +screenshotNameFormat+".png"));
